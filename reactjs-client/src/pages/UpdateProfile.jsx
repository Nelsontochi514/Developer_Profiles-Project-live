...
function UpdateProfile() {
  ...
  useEffect(() => {
    ...
    const url = `https://developer-profile-project-live-g3bn.onrender.com/api/v1/profiles/get-profile/${profileId}`;
  ...
  async function handleUpdateProfile(e) {
    ...
    const updatedProfile = await axios.patch(
      `https://developer-profile-project-live-g3bn.onrender.com/api/v1/profiles/update-profile/${profileId}`,
      profileData
    );
